...
/* harmony import */ var _modals__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modals */ "./js/modules/modals.js");
...
function forms(fromSelector, modalTimerId) {
  ...
  function showThanksModal(message) {
    var preyModalDialog = document.querySelector('.modal__dialog');
    preyModalDialog.classList.add('hide');
    Object(_modals__WEBPACK_IMPORTED_MODULE_8__["openModal"])('.modal', modalTimerId);
    ...
    setTimeout(function () {
      ...
      Object(_modals__WEBPACK_IMPORTED_MODULE_8__["closeModal"])('.modal');
    }, 4000);
  }
}
...
function modals(TriggerModal, modalSelector, modalTimerId) {
  // Modal 
  var btnModal = document.querySelectorAll(TriggerModal),
...
function sliders(_ref) {
  var sliderSelcetor = _ref.sliderSelcetor,
      slidersSelector = _ref.slidersSelector,
      preArrow = _ref.preArrow,
      ...
      field = _ref.field;
  // Sliders 
  var pre = document.querySelector(preArrow),
  ...
  if (slider.length < 10) {
    total.textContent = "0".concat(slider.length);
  ...
  function currentCount(count) {
    if (slider.length < 10) {
      count.textContent = "0".concat(sliderIndex);
    } else {
